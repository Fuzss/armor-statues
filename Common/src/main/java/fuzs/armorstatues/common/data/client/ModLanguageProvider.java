package fuzs.armorstatues.common.data.client;
...
public class ModLanguageProvider extends AbstractLanguageProvider {
    ...
    public void addTranslations() {
        ...
        this.add(ArmorStandScreenTypes.POSITION.getTranslationKey(), "Position");
        this.add(ArmorStandScreenTypes.ALIGNMENTS.getTranslationKey(), "Alignments");
        this.add(ArmorStandScreenTypes.VANILLA_TWEAKS.getTranslationKey(), "Vanilla Tweaks");
        ...
        this.add(ArmorStandVanillaTweaksScreen.CHECK_TARGET_DESCRIPTION_KEY,
        ...
        this.add(ArmorStandVanillaTweaksScreen.LOCK_DESCRIPTION_KEY,
        ...
        this.add(ArmorStandVanillaTweaksScreen.UNLOCK_DESCRIPTION_KEY,
        ...
        this.add(ArmorStandVanillaTweaksScreen.TOOL_RACK_DESCRIPTION_KEY,
        ...
        this.add(ArmorStandVanillaTweaksScreen.SWAP_MAINHAND_AND_OFFHAND_DESCRIPTION_KEY,
        ...
        this.add(ArmorStandVanillaTweaksScreen.SWAP_MAINHAND_AND_HEAD_DESCRIPTION_KEY,
